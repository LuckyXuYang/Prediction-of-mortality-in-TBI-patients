...
%% 路径设置 set path
img_dir  = 'C:\Users\Administrator\Desktop\MSTBIdata\images';
mask_dir = 'C:\Users\Administrator\Desktop\MSTBIdata\masks';
csv_file = 'C:\Users\Administrator\Desktop\MSTBIdata\category.csv';
save_dir = 'C:\Users\Administrator\Desktop\MSTBIdata';
...
for i = 1:length(filename_list)
    ...
    [img4stage2,mask4stage2] = cutROIwithExpand(img, mask, stage2_aim_size);
    
    % 计算size
    %nodule_size = sum(sum(mask4stage1));
    nodule_size = sum(sum(mask4stage2));
    ...
    % 保存图片
    % for stage1
    imwrite(img4stage2,[save_dir,filesep,'stage1',filesep,'p_image',filesep,filename_list{i}]);
    imwrite(mask4stage2,[save_dir,filesep,'stage1',filesep,'p_mask',filesep,filename_list{i}]);
    % for stage2
