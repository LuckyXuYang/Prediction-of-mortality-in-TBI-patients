...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_epochs', type=int, default=100) #405

    parser.add_argument('--num_epochs_decay', type=int, default=60)  # decay开始的最小epoch数 60
    parser.add_argument('--decay_ratio', type=float, default=0.01) #0~1,每次decay到1*ratio
    parser.add_argument('--decay_step', type=int, default=60)  # epoch 60

    parser.add_argument('--batch_size', type=int, default=2) #10
    parser.add_argument('--batch_size_test', type=int, default=6) #30
    ...
    parser.add_argument('--lr_cos_epoch', type=int, default=95)  # cos退火的epoch数,一般就是总epoch数-warmup的数,为0或False则代表不使用

    # optimizer param
    parser.add_argument('--beta1', type=float, default=0.5)        # momentum1 in Adam
    parser.add_argument('--beta2', type=float, default=0.999)      # momentum2 in Adam
    parser.add_argument('--augmentation_prob', type=float, default=1.0)  # 扩增几率
    parser.add_argument('--save_model_step', type=int, default=20) #20
    parser.add_argument('--val_step', type=int, default=1)

    # misc
    parser.add_argument('--mode', type=str, default='train', help='train/test')
    parser.add_argument('--tta_mode', type=bool, default=True) #是否在训练过程中的validation使用tta
    parser.add_argument('--Task_name', type=str, default='test', help='DIR name,Task name') #dpv3plus_stage1_
    parser.add_argument('--cuda_idx', type=int, default=0)
    parser.add_argument('--DataParallel', type=bool, default=False)

    # data-parameters
    parser.add_argument('--filepath_img', type=str, default=r'C:\Users\Administrator\Desktop\MSTBIdata\images')
    parser.add_argument('--filepath_mask', type=str, default=r'C:\Users\Administrator\Desktop\MSTBIdata\masks')
    parser.add_argument('--csv_file', type=str, default=r'C:\Users\Administrator\Desktop\MSTBIdata\Train.csv')
    parser.add_argument('--fold_K', type=int, default=5, help='folds number after divided') #5
    parser.add_argument('--fold_idx', type=int, default=1)

    # result&save
    parser.add_argument('--result_path', type=str, default='./resultMSTBIdata-unet/stage1_bs2_bst6-resnet18')
    ...
    parser.add_argument('--validate_flag', type=bool, default=False) # 是否有验证集 False
